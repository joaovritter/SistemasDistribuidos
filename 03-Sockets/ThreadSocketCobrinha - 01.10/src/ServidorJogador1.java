...
public class ServidorJogador1 extends javax.swing.JFrame {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (c.tipo == Componente.JOGADOR) {
                            ...
                            Movimenta.posicionaBarreiras(barreiras, jPanelJogador1.getBounds().width, jPanelJogador1.getBounds().height);
                        }
                    }                } catch (Exception e) {
    ...
    private void btnReiniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReiniciarActionPerformed
        Movimenta.reiniciarPartida(txtPlacar, 
                               ...
                               jPanelJogador1.getBounds().height); 
        try {
            Componente cmd = new Componente(Componente.REINICIAR, 0, 0, false);
            comunicador.enviaComponente(cmd);
            // Envia também a fruta para o cliente atualizar e recalcular barreiras
            Componente frutaAtual = new Componente(jButtonFruta.getBounds().x,
                                                   jButtonFruta.getBounds().y,
                                                   jButtonFruta.getBounds().width,
                                                   jButtonFruta.getBounds().height);
            frutaAtual.tipo = Componente.FRUTA;
            comunicador.enviaComponente(frutaAtual);
        } catch (Exception e) {
